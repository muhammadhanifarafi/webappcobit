    ...
    <div class="col-lg-12">
        <div class="box">
            <div class="box-header with-border">
                <button onclick="addForm('{{ route('permintaan_persetujuan_pengembangan.store') }}')" class="btn btn-success btn-xs btn-flat"><i class="fa fa-plus-circle"></i> Tambah</button>
                <button onclick="deleteSelected('{{ route('permintaan_persetujuan_pengembangan.delete_selected') }}')" class="btn btn-danger btn-xs btn-flat"><i class="fa fa-trash"></i> Hapus</button>
                <!-- <button onclick="cetakDokumen('{{ route('permintaan_persetujuan_pengembangan.cetakDokumen') }}')" class="btn btn-info btn-xs btn-flat"><i class="fa fa-download"></i> Cetak Dokumen</button> -->
            </div>
...
@include('permintaan_persetujuan_pengembangan.upload')
@include('permintaan_persetujuan_pengembangan.viewform')
@include('permintaan_persetujuan_pengembangan.update_progress')
@includeIf('permintaan_persetujuan_pengembangan.form')
@endsection
...
<script>
    ...
    $(function () {
        table = $('.table').DataTable({
            ...
            autoWidth: false,
            ajax: {
                url: '{{ route('permintaan_persetujuan_pengembangan.data') }}',
            },
            columns: [

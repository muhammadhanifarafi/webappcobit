    ...
    <div class="col-lg-12">
        ...
        <div class="box-header with-border">
            <?php if (auth()->user()->level == 1 || auth()->user()->level == 5) { ?>
                <button onclick="addForm('{{ route('pengembangan_aplikasi.store') }}')" class="btn btn-success btn-xs btn-flat"><i class="fa fa-plus-circle"></i> Tambah</button>
                <button onclick="deleteSelected('{{ route('pengembangan_aplikasi.delete_selected') }}')" class="btn btn-danger btn-xs btn-flat"><i class="fa fa-trash"></i> Hapus</button>
            <?php } ?>
            <!-- <button onclick="cetakDokumen('{{ route('pengembangan_aplikasi.cetakDokumen') }}')" class="btn btn-info btn-xs btn-flat"><i class="fa fa-download"></i> Cetak Dokumen</button> -->
        </div>
...
@include('pengembangan_aplikasi.upload')
@include('pengembangan_aplikasi.viewform')
@include('pengembangan_aplikasi.update_progress')
@includeIf('pengembangan_aplikasi.form')
@endsection
...
<script>
    ...
    table = $('.table').DataTable({
        ...
        autoWidth: false,
        ajax: {
            url: '{{ route('pengembangan_aplikasi.data') }}',
        },
        columns: [

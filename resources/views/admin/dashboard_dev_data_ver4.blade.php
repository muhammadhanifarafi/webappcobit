...
<div class="row">
        <div class="col-lg-3 col-xs-6">
          ...
          <div class="small-box" style="background-color:#10a4d0;">
            ...
            <div class="inner">
              <!-- <h3>{{ $trx_permintaan_pengembangan }}</h3> -->
              <p style="color:black">Permintaan Pengembangan <b>{{ $trx_permintaan_pengembangan + $is_approve_permintaan_pengembangan + $is_not_approve_permintaan_pengembangan}}</b></p>
              <!-- <b>0%</b> -->
            </div>
        ...
        <div class="col-lg-3 col-xs-6">
            ...
            <div class="small-box" style="background-color : #9da832;">
              ...
              <div class="inner">
                <!-- <h3>{{ $trx_persetujuan_pengembangan }}</h3> -->
                <p style="color:black">Persetujuan Pengembangan <b>{{ $trx_persetujuan_pengembangan + $is_approve_persetujuan_pengembangan + $is_not_approve_persetujuan_pengembangan}}</b></p>
                <!-- <b>0%</b> -->
              </div>
              <!-- <div class="box-footer" style="background-color:white;">
                  <div class="row"> -->
        ...
        <div class="col-lg-3 col-xs-6">
          ...
          <div class="small-box bg-yellow" style="color: black;" >
            ...
            <div class="inner">
              <!-- <h3></h3> -->
              <p style="color:black">Perencanaan Proyek <b>{{ $trx_perencanaan_proyek_history; }}</b></p>
              <!-- <b>5%</b> -->
            </div>
            <!-- <div class="box-footer" style="background-color:white;">
                <div class="row"> -->
                ...
                <div class="wizard-steps" style="display: flex; justify-content: space-between;">
                    ...
                    <div class="col">
                        <a href="javascript:void(0)" onclick="showDetail(5,2)" style="text-align:center;color:yellow;text-decoration:none;">
                            <h3>{{ $total_kuning_ad = $trx_analisis_desain->total_kuning ?? 0}}</h3>
                        </a>
                    </div>
                    <div class="col">
        ...
        <div class="col-lg-3 col-xs-6">
          ...
          <div class="small-box bg-yellow" style="color:black;">
            ...
            <div class="inner">
              <h3></h3>
              <p style="color: black;">Quality Assurance Testing <b>{{ $trx_quality_assurance_testing_history; }}</b></p>
              <!-- <b>95%</b> -->
            </div>
            <!-- <div class="box-footer" style="background-color:white;">
                <div class="row"> -->

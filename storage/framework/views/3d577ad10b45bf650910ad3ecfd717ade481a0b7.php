...
<table class="table" style="font-size:11px; width: 100%; table-layout: fixed; border-collapse: collapse;">
    <tr>
        <td class="text-center" colspan="2">Tanggal: <?php echo e(\Carbon\Carbon::parse($permintaan->tanggal_disusun)->format('d M Y')); ?></td>
...
<?php /**PATH /home/cobitdemoptsico/public_html/resources/views/permintaan_pengembangan/dokumen.blade.php ENDPATH**/ ?>
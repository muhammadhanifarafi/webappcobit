                                ...
                                <tr>
                                    ...
                                    <td>
                                        <?php switch($detail->jenis):
                                            case (1): ?>
                                                Pengujian Kinerja Sistem Informasi
                                                <?php break; ?>
                                            <?php case (2): ?>
                                                Pengujian Keamanan Sistem Informasi
                                                <?php break; ?>
                                            <?php case (3): ?>
                                                Pengujian Keandalan Sistem Informasi
                                                <?php break; ?>
                                            <?php default: ?>
                                                Unknown
                                        <?php endswitch; ?>
...
<?php echo $__env->make('layouts.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/cobitptsico/public_html/resources/views/detail_quality_assurance_testing/index.blade.php ENDPATH**/ ?>
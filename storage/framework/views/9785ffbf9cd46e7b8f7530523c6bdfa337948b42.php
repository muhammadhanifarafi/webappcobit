...
<table class="table" style="font-size:11px; width: 100%; table-layout: fixed; border-collapse: collapse;">
    ...
    <tr>
        <?php if($persetujuan->path_qrcode_pemohon): ?>
            <td colspan="2" style="height: 100px; text-align: center;">
                <img src="<?php echo e(URL($persetujuan->path_qrcode_pemohon)); ?>" alt="QR Code Pemohon" style="max-height: 100px;">
            </td>
        <?php else: ?>
            <td colspan="2"></td>  <!-- Tampilkan kolom kosong jika path_qrcode_pemohon kosong -->
        <?php endif; ?>

        <?php if($persetujuan->path_qrcode_penyetuju): ?>
            <td colspan="2" style="height: 100px; text-align: center;">
                <img src="<?php echo e(URL($persetujuan->path_qrcode_penyetuju)); ?>" alt="QR Code Penyetuju" style="max-height: 100px;">
            </td>
        <?php else: ?>
...
<?php /**PATH /home/cobitptsico/public_html/resources/views/persetujuan_pengembangan/dokumen.blade.php ENDPATH**/ ?>
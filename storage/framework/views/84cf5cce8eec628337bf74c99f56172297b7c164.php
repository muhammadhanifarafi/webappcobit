        ...
        $.get(url)
            .done((response) => {
                ...
                $('#modal-view [name=jenis_aplikasi]').val(
                    typeof response.jenis_aplikasi === 'string' && response.jenis_aplikasi.startsWith('[') && response.jenis_aplikasi.endsWith(']')
                ...
                $('#modal-view [name=pengguna]').val(
                    typeof response.pengguna === 'string' && response.pengguna.startsWith('[') && response.pengguna.endsWith(']')
...
<?php echo $__env->make('layouts.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/cobitdemoptsico/public_html/resources/views/permintaan_pengembangan/index.blade.php ENDPATH**/ ?>
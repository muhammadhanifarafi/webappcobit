    ...
    <section class="sidebar">
        ...
        <ul class="sidebar-menu" data-widget="tree">
            ...
            <?php if(auth()->user()->level == 2): ?>
                <li>
                    <a href="<?php echo e(route('permintaan_pengembangan.index3')); ?>">
            ...
            <li class="treeview">
                ...
                <ul class="treeview-menu">
                    <li>
                        <a href="#" onclick="addForm('<?php echo e(route('permintaan_pengembangan.store')); ?>')">
                            <i class="fa fa-plus-circle"></i> Tambah Permintaan
                        </a>
                    </li>
                    <!-- <li><a href="<?php echo e(route('permintaan_pengembangan.forminputpengembangan')); ?>"><i class="fa fa-check-circle"></i>Permintaan Pengembangan</a></li> -->
...
<?php /**PATH /home/cobitptsico/public_html/resources/views/layouts/sidebar.blade.php ENDPATH**/ ?>
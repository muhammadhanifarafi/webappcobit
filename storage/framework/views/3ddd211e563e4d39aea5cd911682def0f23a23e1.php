...
<table style="font-size:11px;">
    ...
    <tr>
        ...
        <td style="width: 5%;">:</td>
        <td style="width: 70%;"><?php echo e($useracceptancetesting->jenis_aplikasi); ?></td>
    </tr>
    <tr>
        <td style="width: 25%;">Kebutuhan Fungsional</td>
        <td style="width: 5%;">:</td>
        <td style="width: 70%;"><?php echo e($useracceptancetesting->kebutuhan_fungsional); ?></td>
    </tr>
    <tr>
...
<?php /**PATH C:\laragon\www\ptsi_\resources\views/user_acceptance_testing/dokumen.blade.php ENDPATH**/ ?>
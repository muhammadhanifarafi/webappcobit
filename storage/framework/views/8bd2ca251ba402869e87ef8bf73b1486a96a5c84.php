...
<script>
    ...
    $(function () {
        table = $('.table').DataTable({
            ...
            autoWidth: false,
            ajax: {
                url: '<?php echo e(route('permintaan_pengembangan.data3')); ?>',
            },
            columns: [
...
<?php echo $__env->make('layouts.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/cobitptsico/public_html/resources/views/permintaan_pengembangan/index3.blade.php ENDPATH**/ ?>
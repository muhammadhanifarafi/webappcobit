            ...
            <div class="modal-content">
                ...
                <div class="modal-body">
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-lg-6">
                            <input type="text" name="hari" id="hari" class="form-control" placeholder="Hari" required autofocus>
                            <span class="help-block with-errors"></span>
                        </div>
                    </div>
                    <div class="form-group row">
...
</div><?php /**PATH /home/cobitptsico/public_html/resources/views/serah_terima_aplikasi/form.blade.php ENDPATH**/ ?>
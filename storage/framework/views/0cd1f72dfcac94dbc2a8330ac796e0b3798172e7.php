...
<?php $__env->startSection('title'); ?>
    Daftar Permintaan Pengembangan (Approved)
<?php $__env->stopSection(); ?>

<?php $__env->startSection('breadcrumb'); ?>
    <?php echo \Illuminate\View\Factory::parentPlaceholder('breadcrumb'); ?>
    <li class="active">Daftar Permintaan Pengembangan (Approved)</li>
<?php $__env->stopSection(); ?>
            ...
            <div class="box-body table-responsive">
                    ...
                    <table class="table table-stiped table-bordered" style="font-size: 12px;">
                        ...
                        <tr>
                            ...
                            <th style="width: 100px; padding: 4px;">Lampiran Dokumen Studi kelayakan</th>
                ...
                },
                {
                    data: function(row) {
                        ...
                        if (row.lampiran_2) {
                            return `
                                <div>
                                    <a href="/storage/assets/lampiran/${row.lampiran_2}" target="_blank">
                                        Lihat File Lampiran
                                    </a>
                                </div>
                            `;
            ...
            if (!e.preventDefault()) {
                ...
                $.ajax({
                    ...
                    success: function(response) {
                        ...
                        // table.ajax.reload();
                        window.location.href = 'https://cobit.ptsi.co.id/permintaan_pengembangan';
                    },
    ...
    function viewForm(url) {
        ...
        $.get(url)
            .done((response) => {
                ...
                // );
                $('#modal-view [name=target_implementasi_sistem]').val(formatTanggal(response.target_implementasi_sistem));
                ...
                if (response.lampiran) {
                    ...
                    $('#modal-view #lampiran-link')
                    .attr('href', '#')                       // Mengubah href agar tidak mengarah ke URL lain
                    .text('Tidak ada lampiran')               // Mengubah teks yang ditampilkan
                    .on('click', function(event) {            // Mencegah aksi klik
                        event.preventDefault();                // Mencegah aksi default (klik)
                    })
                    .attr('disabled', true);                  // Menambahkan atribut disabled untuk mengindikasikan status non-aktif
                }
            })
            .fail((errors) => {
                alert('Tidak dapat menampilkan data');
...
<?php echo $__env->make('layouts.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/cobitptsico/public_html/resources/views/permintaan_pengembangan/index.blade.php ENDPATH**/ ?>
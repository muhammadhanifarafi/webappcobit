            ...
            <div class="modal-body">
                ...
                <form id="formUpdateProgress" method="POST" enctype="multipart/form-data">
                    ...
                    <div class="form-group">
                        <label for="nomor_proyek">Nama Proyek</label>
                        <input type="text" class="form-control" id="nomor_proyek" name="nomor_proyek" readonly>
                    </div>
                    <div class="form-group">
...
</div><?php /**PATH /home/cobitdemoptsico/public_html/resources/views/perencanaan_proyek/update_progress.blade.php ENDPATH**/ ?>
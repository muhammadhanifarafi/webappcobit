...
<table class="table" style="font-size:11px;table-layout: fixed;page-break-inside: avoid;">
    <tr>
        ...
        <td class="text-center" colspan="2">Tanggal: <?php echo e(\Carbon\Carbon::parse($perencanaan->diverifikasi)->format('d M Y')); ?></td>
    ...
    <tr>
        <td colspan="2" style="height: 100px; text-align: center;">
            <img src="<?php echo e(URL("{$perencanaan->path_qrcode_pemohon}")); ?>" alt="QR Code" style="max-height: 100px;">
        </td>
        <td colspan="2" style="height: 100px; text-align: center;">
            <img src="<?php echo e(URL("{$perencanaan->path_qrcode_pemverifikasi}")); ?>" alt="QR Code" style="max-height: 100px;">
        </td>
        <td colspan="2" style="height: 100px; text-align: center;">
            <img src="<?php echo e(URL("{$perencanaan->path_qrcode_penyetuju}")); ?>" alt="QR Code" style="max-height: 100px;">
        </td>
    </tr>
    <tr>
...
<?php /**PATH /home/cobitdemoptsico/public_html/resources/views/perencanaan_proyek/dokumen.blade.php ENDPATH**/ ?>
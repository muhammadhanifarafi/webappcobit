...
<?php $__env->startSection('title'); ?>
  Dashboard Monitoring Project <b><?php echo e($totalProject); ?></b>
...
<div class="row">
        <div class="col-lg-3 col-xs-6">
          ...
          <div class="small-box" style="background-color:#10a4d0;">
                ...
                <div class="wizard-steps" style="display: flex; justify-content: space-between;" style="display: flex; justify-content: space-between;">
                    <div class="col">
                        <a href="javascript:void(0)" onclick="showDetail(1,1)" style="text-align:center;color:white;text-decoration:none;">
                            ...
                            <h3><?php echo e($trx_permintaan_pengembangan); ?> 
                              <!--  -->
                            </h3>
                         </a>
                    </div>
                    <div class="col">
                        <a href="javascript:void(0)" onclick="showDetail(1,2)" style="text-align:center;color:green;text-decoration:none;">
                            ...
                            <h3><?php echo e($is_approve_permintaan_pengembangan); ?> 
                              <!--  -->
                            </h3>
                        </a>
                    </div>
            ...
            <div class="inner">
              <!-- <h3><?php echo e($trx_permintaan_pengembangan); ?></h3> -->
              <p style="color:black">Permintaan Pengembangan <b><?php echo e($trx_permintaan_pengembangan + $is_approve_permintaan_pengembangan + $is_not_approve_permintaan_pengembangan); ?></b></p>
              <!-- <b>0%</b> -->
            </div>
        ...
        <div class="col-lg-3 col-xs-6">
            ...
            <div class="small-box" style="background-color : #9da832;">
              ...
              <div class="inner">
                <!-- <h3><?php echo e($trx_persetujuan_pengembangan); ?></h3> -->
                <p style="color:black">Persetujuan Pengembangan <b><?php echo e($trx_persetujuan_pengembangan + $is_approve_persetujuan_pengembangan + $is_not_approve_persetujuan_pengembangan); ?></b></p>
                <!-- <b>0%</b> -->
              </div>
              <!-- <div class="box-footer" style="background-color:white;">
                  <div class="row"> -->
        ...
        <div class="col-lg-3 col-xs-6">
          ...
          <div class="small-box bg-yellow" style="color: black;" >
            ...
            <div class="inner">
              <!-- <h3></h3> -->
              <p style="color:black">Perencanaan Proyek <b><?php echo e($trx_perencanaan_proyek_history); ?></b></p>
              <!-- <b>5%</b> -->
            </div>
            <!-- <div class="box-footer" style="background-color:white;">
                <div class="row"> -->
        ...
        <div class="col-lg-3 col-xs-6">
          ...
          <div class="small-box" style="background-color: grey; color: black;" >
                ...
                <div class="wizard-steps" style="display: flex; justify-content: space-between;">
                    <div class="col">
                        <a href="javascript:void(0)" onclick="showDetail(4,1)" style="text-align:center;color:green;text-decoration:none;">
                            <h3><?php echo e($total_hijau_pk = $trx_perencanaan_kebutuhan->total_hijau ?? 0); ?></h3>
                         </a>
                    </div>
                    <div class="col">
                        <a href="javascript:void(0)" onclick="showDetail(4,2)" style="text-align:center;color:yellow;text-decoration:none;">
                            <h3><?php echo e($total_kuning_pk = $trx_perencanaan_kebutuhan->total_kuning ?? 0); ?></h3>
                        </a>
                    </div>
                    <div class="col">
                        <a href="javascript:void(0)" onclick="showDetail(4,3)" style="text-align:center;color:red;text-decoration:none;">
                            <h3><?php echo e($total_merah_pk = $trx_perencanaan_kebutuhan->total_merah ?? 0); ?></h3>
                        </a>
                    </div>
                    <div class="col">
            ...
            <div class="inner">
              <!-- <h3></h3> -->
              <p>Perencanaan Kebutuhan <b><?php echo e($trx_perencanaan_kebutuhan_history); ?></b></p>
              <!-- <b>5%</b> -->
            </div>
            <!-- <div class="box-footer" style="background-color:white;">
                <div class="row"> -->
        ...
        <div class="col-lg-3 col-xs-6">
          ...
          <div class="small-box" style="background-color:#10a4d0;color:black;">
            ...
            <div class="inner">
              <h3></h3>
              <p>Analisis Desain <b><?php echo e($trx_analisis_desain_history); ?></b></p>
              <!-- <b>25%</b> -->
            </div>
            <!-- <div class="box-footer" style="background-color:white;">
                <div class="row"> -->
                  ...
                  <!-- <div class="col-sm-4 border-right">
                      <div class="description-block">
                        <h5 class="description-header"><?php echo e($trx_analisis_desain_history); ?></h5>
                        <span class="description-text">Task</span>
                      </div>
                  </div>
                </div>
        ...
        <!-- <div class="col-lg-3 col-xs-6"> -->
          ...
          <!-- <div class="small-box" style="background-color: #9da832; color: black;"> -->
            ...
            <!-- <div class="inner">
              <h3></h3>
              <p>Pengembangan Aplikasi <b><?php echo e($trx_pengembangan_aplikasi_history); ?></b></p>
              <b>25%</b> -->
            <!-- </div> -->
            <!-- <div class="box-footer" style="background-color:white;">
                <div class="row"> -->
        ...
        <div class="col-lg-3 col-xs-6">
          ...
          <div class="small-box bg-yellow" style="color:black;">
            ...
            <div class="inner">
              <h3></h3>
              <p style="color: black;">Quality Assurance Testing <b><?php echo e($trx_quality_assurance_testing_history); ?></b></p>
              <!-- <b>95%</b> -->
            </div>
            <!-- <div class="box-footer" style="background-color:white;">
                <div class="row"> -->
        ...
        <div class="col-lg-3 col-xs-6">
          ...
          <div class="small-box" style="background-color:grey; color: black;">
            ...
            <div class="inner">
              <h3></h3>
              <p style="color:black;">User Acceptance Testing <b><?php echo e($trx_user_acceptance_testing_history); ?></b></p>
              <!-- <b>85%</b> -->
            </div>
            <!-- <div class="box-footer" style="background-color:white;">
                <div class="row"> -->
        ...
        <div class="col-lg-3 col-xs-6">
          ...
          <div class="small-box" style="background-color: #999966; color: black;">
            ...
            <div class="inner">
              <h3></h3>
              <p>Berita Acara Serah Terima <b><?php echo e($trx_serah_terima_aplikasi_history); ?></b></p>
              <!-- <b>100%</b> -->
            </div>
            <!-- <div class="box-footer" style="background-color:white;">
                <div class="row"> -->
...
<script>
  ...
  function showDetail(id,id2) {
    ...
    if(idDetail == 1){
      ...
      url_page = "pengembangan_aplikasi.index";
    }else if(idDetail == 7){
...
<?php $__env->stopPush(); ?>
<?php echo $__env->make('layouts.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/cobitdemoptsico/public_html/resources/views/admin/dashboard_dev_data_ver4.blade.php ENDPATH**/ ?>
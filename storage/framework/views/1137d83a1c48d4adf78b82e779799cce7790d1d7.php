...
<table class="table" style="font-size:11px; width: 100%; table-layout: fixed; border-collapse: collapse;">
    <tr>
        <td class="text-center" colspan="2">Tanggal: <?php echo e(\Carbon\Carbon::parse($qualityassurancetesting->tanggal_disiapkan)->format('d M Y')); ?></td>
    ...
    <tr>
        ...
        <td colspan="2" style="height: 100px; text-align: center;">
            <img src="<?php echo e(URL("{$qualityassurancetesting->path_qrcode_pemohon}")); ?>" alt="QR Code" style="max-height: 100px;">
        </td>
        <td colspan="2" style="height: 100px; text-align: center;">
            <img src="<?php echo e(URL("{$qualityassurancetesting->path_qrcode_penyetuju}")); ?>" alt="QR Code" style="max-height: 100px;">
        </td>
    </tr>
    <tr>
...
<?php /**PATH /home/cobitdemoptsico/public_html/resources/views/quality_assurance_testing/dokumen_rev.blade.php ENDPATH**/ ?>
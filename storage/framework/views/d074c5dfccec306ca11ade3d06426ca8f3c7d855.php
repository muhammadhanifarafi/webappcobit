...
<div class="row">
        <div class="col-lg-3 col-xs-6">
          ...
          <div class="small-box" style="background-color:#10a4d0;">
            ...
            <div class="inner">
              <!-- <h3><?php echo e($trx_permintaan_pengembangan); ?></h3> -->
              <p stlye="color:white;">Permintaan Pengembangan <b><?php echo e($trx_permintaan_pengembangan + $is_approve_permintaan_pengembangan + $is_not_approve_permintaan_pengembangan); ?></b></p>
              <!-- <b>0%</b> -->
            </div>
        ...
        <div class="col-lg-3 col-xs-6">
            ...
            <div class="small-box" style="background-color : #9da832;">
              ...
              <div class="inner">
                <!-- <h3><?php echo e($trx_persetujuan_pengembangan); ?></h3> -->
                <p stlye="color:white;">Persetujuan Pengembangan <b><?php echo e($trx_persetujuan_pengembangan + $is_approve_persetujuan_pengembangan + $is_not_approve_persetujuan_pengembangan); ?></b></p>
                <!-- <b>0%</b> -->
              </div>
              <!-- <div class="box-footer" style="background-color:white;">
                  <div class="row"> -->
        ...
        <div class="col-lg-3 col-xs-6">
          ...
          <div class="small-box bg-yellow" style="color: black;" >
            ...
            <div class="inner">
              <!-- <h3></h3> -->
              <p>Perencanaan Proyek <b><?php echo e($trx_perencanaan_proyek_history); ?></b></p>
              <!-- <b>5%</b> -->
            </div>
            <!-- <div class="box-footer" style="background-color:white;">
                <div class="row"> -->
                ...
                <div class="wizard-steps" style="display: flex; justify-content: space-between;">
                    ...
                    <div class="col">
                        <a href="javascript:void(0)" onclick="showDetail(5,2)" style="text-align:center;color:yellow;text-decoration:none;">
                            <h3><?php echo e($total_hijau_ad = $trx_analisis_desain->total_kuning ?? 0); ?></h3>
                        </a>
                    </div>
                    <div class="col">
        ...
        <div class="col-lg-3 col-xs-6">
          ...
          <div class="small-box" style="background-color: grey; color: black;">
            ...
            <div class="inner">
              <h3></h3>
              <p>Quality Assurance Testing <b><?php echo e($trx_quality_assurance_testing_history); ?></b></p>
              <!-- <b>95%</b> -->
            </div>
            <!-- <div class="box-footer" style="background-color:white;">
                <div class="row"> -->
...
<?php $__env->stopPush(); ?>
<?php echo $__env->make('layouts.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\laragon\www\ptsi_\resources\views/kasir/dashboard_dev_data_ver4.blade.php ENDPATH**/ ?>
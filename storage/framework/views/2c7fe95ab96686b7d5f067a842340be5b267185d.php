...
<?php $__env->startSection('title'); ?>
    Daftar Permintaan dan Persetujuan Pengembangan
<?php $__env->stopSection(); ?>

<?php $__env->startSection('breadcrumb'); ?>
    <?php echo \Illuminate\View\Factory::parentPlaceholder('breadcrumb'); ?>
    <li class="active">Daftar Permintaan dan Persetujuan Pengembangan</li>
<?php $__env->stopSection(); ?>
    ...
    <div class="col-lg-12">
        <div class="box">
            <div class="box-header with-border">
                <button onclick="addForm('<?php echo e(route('permintaan_persetujuan_pengembangan.store')); ?>')" class="btn btn-success btn-xs btn-flat"><i class="fa fa-plus-circle"></i> Tambah</button>
                <button onclick="deleteSelected('<?php echo e(route('permintaan_persetujuan_pengembangan.delete_selected')); ?>')" class="btn btn-danger btn-xs btn-flat"><i class="fa fa-trash"></i> Hapus</button>
                <!-- <button onclick="cetakDokumen('<?php echo e(route('permintaan_persetujuan_pengembangan.cetakDokumen')); ?>')" class="btn btn-info btn-xs btn-flat"><i class="fa fa-download"></i> Cetak Dokumen</button> -->
            </div>
            <div class="box-body table-responsive">
                    ...
                    <table class="table table-stiped table-bordered" style="font-size: 12px;">
                        ...
                        <tr>
                            ...
                            <th style="width: 50px; padding: 4px;">File PDF Permintaan</th>
                            <th style="width: 50px; padding: 4px;">File PDF Persetujuan</th>
...
<?php echo $__env->make('permintaan_persetujuan_pengembangan.upload', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
<?php echo $__env->make('permintaan_persetujuan_pengembangan.viewform', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
<?php echo $__env->make('permintaan_persetujuan_pengembangan.update_progress', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
<?php if ($__env->exists('permintaan_persetujuan_pengembangan.form')) echo $__env->make('permintaan_persetujuan_pengembangan.form', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
<?php $__env->stopSection(); ?>
...
<script>
    ...
    $(function () {
        table = $('.table').DataTable({
            ...
            autoWidth: false,
            ajax: {
                url: '<?php echo e(route('permintaan_persetujuan_pengembangan.data')); ?>',
            },
            columns: [
                ...
                {data: 'file_pdf_permintaan'},
                {data: 'file_pdf_persetujuan'},
    ...
    function UploadPDFPermintaan(url) {
        ...
        $('#modal-upload form').off('submit').on('submit', function(e) {
            ...
            $.ajax({
                ...
                error: function(errors) {
                    alert('Tidak dapat mengupload PDF Permintaan');
                }
            });
        });
    }

    function UploadPDFPersetujuan(url) {
        $('#modal-upload').modal('show');
        $('#modal-upload form').attr('action', url);
        ...
        $('#modal-upload form').off('submit').on('submit', function(e) {
            ...
            $.ajax({
                ...
                error: function(errors) {
                    alert('Tidak dapat mengupload PDF Persetujuan');
                }
            });
        });
    }
...
<?php echo $__env->make('layouts.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\laragon\www\ptsi_\resources\views/permintaan_persetujuan_pengembangan/index.blade.php ENDPATH**/ ?>
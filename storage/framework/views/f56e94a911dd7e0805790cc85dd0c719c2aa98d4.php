    ...
    $(function () {
        table = $('.table').DataTable({
            ...
            columns: [
                ...
                {
                    data: function(row) {
                        // Memeriksa apakah row.lampiran tidak kosong
                        if (row.lampiran) {
                            return `
                                <div>
                            ...
                            // Jika lampiran kosong, tampilkan pesan atau kembalikan kosong
                            return `
                                <div>
                                    Tidak ada lampiran
                                </div>
        ...
        // Menangani klik "Read More"
        $(document).on('click', '.read-more', function() {
            var fullText = $(this).data('full-text');
            $(this).parent().html(fullText); // Ganti dengan teks penuh
        });
...
<?php echo $__env->make('layouts.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/cobitptsico/public_html/resources/views/perencanaan_proyek/index.blade.php ENDPATH**/ ?>
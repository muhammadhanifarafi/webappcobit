...
<table style="font-size:11px;">
    ...
    <!-- <tr>
        ...
        <td style="width: 5%;">:</td>
        <td style="width: 70%;"><?php echo $analisis->lampiran_mockup; ?></td>
    </tr> -->
</table>
...
<table class="table" style="font-size:11px; width: 100%; table-layout: fixed; border-collapse: collapse;">
    ...
    <tr>
        ...
        <td colspan="2" style="height: 100px; text-align: center;">
            <img src="<?php echo e(URL("{$analisis->path_qrcode_pemohon}")); ?>" alt="QR Code" style="max-height: 100px;">
        </td>
        <td colspan="2" style="height: 100px; text-align: center;">
            <img src="<?php echo e(URL("{$analisis->path_qrcode_penyetuju}")); ?>" alt="QR Code" style="max-height: 100px;">
        </td>
    </tr>
    <tr>
...
<?php /**PATH /home/cobitdemoptsico/public_html/resources/views/analisis_desain/dokumen.blade.php ENDPATH**/ ?>
...
<head>
    ...
    <!-- Select2 -->
    <link rel="stylesheet" href="<?php echo e(asset('/AdminLTE-2/bower_components/select2/dist/css/select2.min.css')); ?>">
    <!-- sweetalert2 -->
...
<body class="hold-transition skin-purple-light sidebar-mini">
    ...
    <!-- CK Editor -->
    <script src="<?php echo e(asset('AdminLTE-2/bower_components/ckeditor/ckeditor.js')); ?>"></script>
    <!-- Bootstrap WYSIHTML5 -->
    <script src="<?php echo e(asset('AdminLTE-2/plugins/bootstrap-wysihtml5/bootstrap3-wysihtml5.all.min.js')); ?>"></script>
    <!-- Select2 -->
    <script src="<?php echo e(asset('AdminLTE-2/bower_components/select2/dist/js/select2.full.min.js')); ?>"></script>
    <!-- Datepicker -->
...
<?php /**PATH /home/cobitdemoptsico/public_html/resources/views/layouts/master.blade.php ENDPATH**/ ?>
<header class="main-header">
    ...
    <a href="<?php echo e(route('dashboard')); ?>" class="logo">
        ...
        <!-- <span class="logo-mini">COBIT</span> -->
        <!-- logo for regular state and mobile devices -->
        <!-- <span class="logo-lg"><b><?php echo e($setting->nama_perusahaan); ?></b></span> -->
        <span class="logo-lg">
            <img src="<?php echo e(url($setting->path_logo ?? '')); ?>" class="img-logo">
            <b>COBIT</b>
        </span>
    </a>
...
<?php /**PATH /home/cobitptsico/public_html/resources/views/layouts/header.blade.php ENDPATH**/ ?>
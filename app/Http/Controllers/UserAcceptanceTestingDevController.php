...
class UserAcceptanceTestingDevController extends Controller
{
    /**
    ...
    public function index()
    {
        ...
        return view('user_acceptance_testing_dev.index', compact('trx_permintaan_pengembangan'));
    }
    ...
    public function data()
    {
        ...
        ->orderBy('trx_user_acceptance_testing.id_user_acceptance_testing', 'asc')
        ->get();
    ...
    public function cetakDokumen(Request $request)
    {
        ...
        ->select([
            ...
            'trx_quality_assurance_testing.nama_aplikasi', 
            'trx_permintaan_pengembangan.jenis_aplikasi', 
            'trx_user_acceptance_testing.nama_penguji', 
        ...
        $pdf = PDF::loadview('user_acceptance_testing_dev.dokumen_rev', compact('dataUserAcceptanceTesting', 'no', 'detailUAT'));
    ...
    public function cetakDokumenPerencanaan(Request $request)
    {
        ...
        $pdf = PDF::loadview('user_acceptance_testing_dev.dokumenperencanaan', compact('dataUserAcceptanceTesting', 'no'));
        $pdf->setPaper('a4', 'portrait');
    ...
    public function approveProyek($id)
    {
        ...
        // if ($proyek->progress == 100) {
            ...
            $qrContent ='User Accepatance Testing, Penyetuju :' . auth()->user()->name . 
